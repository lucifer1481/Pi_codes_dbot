...
def main(args=None):
    ...
    while rclpy.ok():
        # Allow ROS to process incoming data for 10ms
        rclpy.spin_once(ui_node, timeout_sec=0.01)
        
        # Check services and logic
        ui_node.check_for_finished_calls()
        ui_node.update_image()
        
        # FORCE THE WINDOW TO DRAW PIXELS
        ui_node.ttk.update_idletasks()
        ui_node.ttk.update()
